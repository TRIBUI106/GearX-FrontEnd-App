  ...
  <div class="container mx-auto px-4">
    <div class="max-w-3xl mx-auto justify-items-center">
      <img
        ...
        class="max-w-2xs my-20 rounded-full hover:opacity-70 hover:scale-110 duration-250"
      />
      ...
      >
        ...
        <div class="sm:col-span-2 flex justify-end gap-3 pt-2">
          <button type="button" class="border rounded-xl px-10 py-1">
            Huỷ
          </button>
          <button
            type="submit"
            class="bg-black text-white rounded-xl px-10 py-1"
          >
            Lưu
          </button>
        </div>
